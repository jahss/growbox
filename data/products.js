window.FERTILIZER_PRODUCTS = [
  {
    id:'megacrop-11-5-14', compareGroup:'1-part', brand:'Greenleaf Nutrients', name:'Mega Crop 1-Part 11-5-14', form:'dry',
  ...
  {
    id:'jacks-12-4-16', compareGroup:'1-part', brand:"Jack's Nutrients", name:'12-4-16 RO', form:'dry',
  ...
  {
    id:'jacks-15-5-20-tap', compareGroup:'1-part', brand:"Jack's Nutrients", name:'15-5-20 Tap', form:'dry',
  ...
  {
    id:'jacks-18-8-23-outdoor', compareGroup:'1-part', brand:"Jack's Nutrients", name:'18-8-23 Outdoor', form:'dry',
  ...
  {
    id:'jacks-5-12-26-a', compareGroup:'component', brand:"Jack's Nutrients", name:'5-12-26 Part A', form:'dry',
  ...
  {
    id:'jacks-0-12-26-a', compareGroup:'component', brand:"Jack's Nutrients", name:'0-12-26 Part A', form:'dry',
  ...
  {
    id:'jacks-15-0-0-b', compareGroup:'component', brand:"Jack's Nutrients", name:'15-0-0 Cal Nit Part B', form:'dry',
  ...
  {
    id:'jacks-epsom', compareGroup:'component', brand:"Jack's Nutrients", name:'Magnesium Sulfate (Epsom) Part C', form:'dry',
  ...
  {
    id:'athena-pro-core', compareGroup:'component', brand:'Athena', name:'Pro Core 14-0-0', form:'dry',
  ...
  {
    id:'athena-pro-grow', compareGroup:'component', brand:'Athena', name:'Pro Grow 2-8-20', form:'dry',
  ...
  {
    id:'athena-pro-bloom', compareGroup:'component', brand:'Athena', name:'Pro Bloom 0-12-24', form:'dry',
  ...
  {
    id:'athena-grow-a', compareGroup:'component', brand:'Athena', name:'Blended Grow A 4-0-1', form:'liquid', densityGPerMl:1.179092,
  ...
  {
    id:'athena-grow-b', compareGroup:'component', brand:'Athena', name:'Blended Grow B 1-3-5', form:'liquid', densityGPerMl:1.126368,
  ...
  {
    id:'athena-bloom-a', compareGroup:'component', brand:'Athena', name:'Blended Bloom A 4-0-5', form:'liquid', densityGPerMl:1.195868,
  ...
  {
    id:'athena-bloom-b', compareGroup:'component', brand:'Athena', name:'Blended Bloom B 0.7-6-5', form:'liquid', densityGPerMl:1.155127,
...
window.FERTILIZER_SYSTEMS = [
  {
    id:'megacrop-2part-uploaded', partCount:2, brand:'Greenleaf Nutrients', name:'Mega Crop 2-Part — uploaded 8-12-28 formula',
  ...
  {
    id:'jacks-2part-5-12-26', partCount:2, brand:"Jack's Nutrients", name:'2-Part — 5-12-26 A + Cal Nit B',
    ratioBasis:'mass', components:[
  ...
  {
    id:'jacks-2part-0-12-26', partCount:2, brand:"Jack's Nutrients", name:'2-Part — 0-12-26 A + Cal Nit B',
    ratioBasis:'mass', components:[
  ...
  {
    id:'jacks-321', partCount:3, brand:"Jack's Nutrients", name:'3-Part 3-2-1 — A + B + Magnesium Sulfate C',
    ratioBasis:'mass', components:[
      {productId:'jacks-5-12-26-a',label:'Part A',defaultParts:3.6},
      {productId:'jacks-15-0-0-b',label:'Part B',defaultParts:2.4},
  ...
  {
    id:'athena-pro-veg', partCount:2, brand:'Athena', name:'Pro Line — Veg (Core + Grow)',
    ratioBasis:'mass', components:[
  ...
  {
    id:'athena-pro-bloom', partCount:2, brand:'Athena', name:'Pro Line — Flower (Core + Bloom)',
    ratioBasis:'mass', components:[
      {productId:'athena-pro-core',label:'Core',defaultParts:.6},
  ...
  {
    id:'athena-blended-veg', partCount:2, brand:'Athena', name:'Blended Line — Veg (Grow A + Grow B)',
  ...
  {
    id:'athena-blended-bloom', partCount:2, brand:'Athena', name:'Blended Line — Flower (Bloom A + Bloom B)',
    ratioBasis:'volume', components:[
...
window.FERTILIZER_PRODUCTS.push(
  {
    id:'megacrop-2part-a-8-12-28', compareGroup:'component', brand:'Greenleaf Nutrients', name:'Mega Crop 2-Part A 8-12-28', form:'dry',
  ...
  {
    id:'megacrop-2part-b-15-5-0-0', compareGroup:'component', brand:'Greenleaf Nutrients', name:'Mega Crop 2-Part B 15.5-0-0', form:'dry',
