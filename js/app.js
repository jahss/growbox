...
function exportCSV(){const rows=EXPORT.currentCsvRows(S,{levels:LEVELS,chemistry:CHEM,product:prod,entries:selectedCompareEntries,exportLabel});EXPORT.downloadFile('growbox-fertilizer-results.csv','text/csv',EXPORT.csvText(rows))}
